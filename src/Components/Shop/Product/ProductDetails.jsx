  ...
  return (
    <section className="flex flex-col gap-2 w-full pt-10 px-[250px]">
      <Tooltip title="Anterior">
        <button onClick={handleBack} className="bg-white rounded-full w-10 h-10 justify-center items-center flex transition ease-in delay-50 hover:shadow-md hover:bg-[#cccccc]">
          <LeftArrowIcon />
        </button>
      </Tooltip>
      <div className="flex rounded-md shadow-md w-full bg-white">
        ...
        <div className="grid w-full gap-8 p-8">
          ...
          <button
            className="font-semibold text-lg flex justify-center bg-[#34b042] hover:bg-[#2a8d35] hover:shadow-lg uppercase transition ease-in delay-50 rounded-md text-white py-2"
            type="primary"
            onClick={() => {
