...
export const AddProductModal = ({ open, onCancel, onCreate }) => {
  ...
  return (
    ...
    >
      <Form form={form} layout="horizontal" name="addProduct" size="large" clearOnDestroy>
        <Form.Item
          name="name"
            ...
            },
            {
              validator: (_, value) => {
                if (value >= 0) {
                  ...
                  return Promise.reject(
                    new Error("El precio no puede ser menor que 0")
                  );
                }
              },
            },
            ...
            },
            {
              validator: (_, value) => {
                if (value >= 0) {
                  ...
                  return Promise.reject(
                    new Error("El stock no puede ser menor que 0")
                  );
                }
              },
            },
